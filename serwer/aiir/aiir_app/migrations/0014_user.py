...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('aiir_app', '0013_auto_20150516_1507'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, error_messages={b'unique': b'Uzytkownik o podanej nazwie juz instnieje.'}, verbose_name=b'username', validators=[django.core.validators.RegexValidator(b'^[\\w.@+-]+$', b'Wpisz poprawna nazwe uczytkownika. Moze zawierac jedynie litery, cyfry oraz znaki @/./+/-/_.')])),
